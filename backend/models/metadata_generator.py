...
class MetadataGenerator:
    def __init__(self):
        self.report_folder = os.path.abspath("profiling_reports")
    ...
    def generate_metadata(self, data_path):
        ...
        # report_filename = os.path.join(f"file://{self.report_folder}", f"{os.path.splitext(os.path.basename(data_path))[0]}_sweetviz_report.html")
